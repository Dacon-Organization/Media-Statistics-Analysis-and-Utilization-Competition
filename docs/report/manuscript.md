...
프로젝트 「뉴스 신뢰의 잣대」의 산출물은 아래에서 직접 확인할 수 있다. 7.2절의 자가진단은 설치 없이 이용 가능한 웹사이트로 배포돼 있어 판정 규칙의 실동작을 열한 문항으로 확인할 수 있으며, 판정 근거와 자격 규율은 같은 사이트의 방법론 페이지에 전문 공개했다. 분석의 전 과정은 저장소의 노트북 32종에 실행 출력과 함께 남겼다.

- 자가진단 웹데모(실동작): <https://media-statistics-analysis-and-utili.vercel.app>
